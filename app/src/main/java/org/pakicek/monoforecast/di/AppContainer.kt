...
import org.pakicek.monoforecast.data.repository.EchoRepositoryImpl
...
class AppContainer (private val context: Context) {
    ...
    val echoRepository: EchoRepository by lazy {
        EchoRepositoryImpl(echoApi, prefix = "m3300-01-monoforecast")
    }
